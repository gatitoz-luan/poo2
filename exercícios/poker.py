        ...
        while True:
            ...
            for rodada in range(4):
                ...
                if rodada == 0:
                    ...
                    if lista[small_blind[0]][1] < small_blind[1]:
                        small_blind[1] = lista[small_blind[0]][1]
                    if lista[big_blind[0]][1] < big_blind[1]:
                        big_blind[1] = lista[big_blind[0]][1]
            ...
            compara_pontos = []
            for c in range(len(lista)):
                recebe = mao.verifica.testes(mesa_on[1],lista[c][2:4])
                pontos = int(recebe[0])
                if lista[c][5]==1:
